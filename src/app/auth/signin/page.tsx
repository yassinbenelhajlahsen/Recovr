...
import { ensureUserInDb } from "@/lib/supabase/ensureUser";
import { FloatingInput } from "@/components/ui/FloatingInput";
import { EyeIcon, EyeOffIcon, AppleIcon, GoogleIcon } from "@/components/ui/icons";
              ...
              {view === "reset" ? (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2.5 rounded-xl border border-border bg-elevated hover:bg-surface px-4 py-2.75 text-[15px] font-medium text-primary transition-colors duration-150 disabled:opacity-50 mb-4"
                  >
                    <GoogleIcon />
